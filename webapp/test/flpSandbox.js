		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Gestion de Mesas de Examen",
									"targetURL": "#academia2022zlucc3mesas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"academia2022zlucc3mesas-display": {
								"semanticObject": "academia2022zlucc3mesas",
								"action": "display",
								"description": "Visualizacion y gestion de mesas de examen",
								"title": "Gestion de Mesas de Examen",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=academia2022.zlucc3mesas",
									"url": sap.ui.require.toUrl("academia2022/zlucc3mesas")
								}
							}
						}
					}
